...
class IndProducto1_2_1(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_iniciativas = models.IntegerField(verbose_name='Número de iniciativas',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto1_2_3(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_modelos = models.IntegerField(verbose_name='Número de modelos de inversión',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto1_2_4(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_ofertas = models.IntegerField(verbose_name='Número de oferta de servicios técnicos',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto1_2_5(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_estudio = models.IntegerField(verbose_name='Número de estudio',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto1_4_1(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_documentos = models.IntegerField(verbose_name='Número de documento',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto2_5_1(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_comite = models.IntegerField(verbose_name='Número de Comité',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto2_6_1(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_politica = models.IntegerField(verbose_name='Número de pólitica',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
...
class IndProducto2_6_2(models.Model):
	...
	anio = models.IntegerField('Año')
	semestre = models.IntegerField(choices=SEMESTRE_CHOICES)
	numero_politica = models.IntegerField(verbose_name='Número de Instrumentos',null=True,blank=True)
	fuente = models.CharField(max_length=300,null=True,blank=True,verbose_name='Título y fuente')
	url = models.URLField(null=True,blank=True)
