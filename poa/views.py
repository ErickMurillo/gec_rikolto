...
def ejecucion_financiera(request,id=None,template='poa/ejecucion_financiera.html'):
	...
	for anio in list(sorted(set(years))):
		...
		dict['Funcionamiento General'] = (fun_general['presupuesto'],
											...
											saca_porcentajes(fun_general['acumulado'],fun_general['presupuesto'],False))
		...
		dict['Funcionamiento Programático'] = (funcionamiento_programatico,
												...
												saca_porcentajes(acumulado_programatico,funcionamiento_programatico,False))
		...
		dict['ACTIVIDADES DEL PROGRAMA'] = (actividades_programa['presupuesto'],
											 ...
											 saca_porcentajes(actividades_programa['acumulado'],actividades_programa['presupuesto'],False))
		...
		for obj in efectos:
			...
			dict[nombre_efecto] = (valores_efecto['presupuesto'],
												 ...
												 saca_porcentajes(valores_efecto['acumulado'],valores_efecto['presupuesto'],False))
			...
			for prod in productos:
				...
				dict[nombre_producto] = (valores_producto['presupuesto'],
										...
										saca_porcentajes(valores_producto['acumulado'],valores_producto['presupuesto'],False))
				...
				for act in actividades:
					...
					dict[nombre_actividad] = (valores_actividad['presupuesto'],
											...
											saca_porcentajes(valores_actividad['acumulado'],valores_actividad['presupuesto'],False))
